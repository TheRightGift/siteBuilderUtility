...
class AWSUtility
{
        ...
        if($this->storeTypeHasTemplateCheck($storeTypeId) === 1) {
            ...
            try {
                $n1Command = $this->ssmClient->sendCommand([
                    ...
                    'Parameters' => [
                        'commands' => ['rm -r /var/www/zebralinetest/resources/js/components/websites/mn_1697707753_sQfFGN/', $siteDirectoryCommand, $homeComponentCommand, $navbarCommand, $heroCommand, $categoryCommand, $featuredProductsCommand, $offersCommand, $blogsCommand, $shippingDetailsCommand, $footerCommand, 'cd /var/www/zebralinetest && npm run prod'],
    ...
    public function listCommand()
    {
        $result = $this->ssmClient->listCommandInvocations(
            [
                'CommandId' => 'b83b464e-3bdc-4645-8336-3df4cad38d64',
                'Details' => true,
